...
router.post('/', async function (req, res, next) {
    const { floorNumber, numberofSlot, date, checkin, checkout, chooseSlot } = req.body;
...
//     try {
//         const updatedSlot = await Slots.findByIdAndUpdate(req.params.id, req.body, { new: true });
